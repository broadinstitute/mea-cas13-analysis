...
do   
    ...
    echo $file
    python design_guides.py multi both ./processed_sites/final-full-genome-design/${virus_name[0]}_df.pkl ./gen_results/final-full-genome-design/${virus_name[0]}/ --num_cpu 80 --verbose_results --benchmarking --save_pickled_results --output_to_single_directory 
done  
