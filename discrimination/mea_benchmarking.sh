#!/bin/bash
# Script to benchmark the MEAs on designing guides for SNP identification
...
python design_guides.py diff both ./processed_sites/validation_100seqs_synmismatch.pkl ./gen_results/ext_validation/ --num_cpu 80 --verbose_results --processed_sites_path --save_pickled_results
